...
\begin{lstlisting}[language=C]
x.h                 /* prototipi */
lib_x.c             /* funzioni base */
IRQ_x.c             /* interrupt service routine */
funct_x.c           /* funzioni avanzate */
\end{lstlisting}
...
La libreria dei match register ci facilita la configurazoine, offrendo al match:
\begin{itemize}
