...
\end{itemize}
Inoltre \`e presente anche il \textbf{register status} che \`e una parte di memoria dove sono contenuti i valori di output delle operazioni associate ad ogni registro.
...
\begin{itemize}
    \item issue: un'istruzione \`e presa dalla cosa se una reservation station \`e libera e uno slot nel reorder buffer \`e libero;
\end{itemize}
